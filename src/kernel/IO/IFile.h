...
public:
    ...
    /// <param name="seek_operation">Typ operace</param>
    /// <param name="res_size">Vysledek - velikost, pokud pozadovana</param>
    /// <returns></returns>
    virtual kiv_os::NOS_Error Seek(size_t position, kiv_os::NFile_Seek seek_type, kiv_os::NFile_Seek seek_operation, size_t &res_size);
};
